...
class Tarjeta_Regalo_Terceros(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            logging.basicConfig(filename='log/'+'Tarjeta_Regalo_Terceros'+'_log_'+dt_string, filemode='w', encoding='utf-8', level=logging.INFO, format='[%(asctime)s] [%(levelname)-8s] %(message)s',datefmt='%Y-%m-%d %H:%M:%S')
